...
export const SnakeAiDescription = () => <>
    <Paragraph fontSize={1.25}>
        {"In the past couple of years, the tech industry has been heavily investing in AI research. Interested by this, I wanted to give implementing one a try. Obviously, a simple snake-playing "}
